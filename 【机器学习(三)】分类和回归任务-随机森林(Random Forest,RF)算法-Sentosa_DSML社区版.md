...
随机森林是基于决策树的集成，每棵树都取决于随机变量的集合。对于表示实值输入或预测变量的p维随机向量：![image](https://github.com/user-attachments/assets/7f9879d5-7c9a-4369-bad0-f5bdffbdcd16)
...
![image](https://github.com/user-attachments/assets/c303aeb6-6437-44e3-9fc6-d8637133a0f8)
